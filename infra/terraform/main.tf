...
# S3 Bucket for static assets hosting
...
resource "aws_cloudfront_origin_access_control" "oac" {
  ...
  description                       = "OAC for static web assets bucket access"
...
resource "aws_cloudfront_distribution" "cdn" {
  ...
  # Caching behavior for static assets (images, css, js)
...
# S3 Bucket Policy allowing access only from CloudFront OAC
