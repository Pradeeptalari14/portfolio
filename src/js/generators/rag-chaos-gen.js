...
# Developer Studio configuration compiled for RAG-Chaos
...
def init_rag_node():
    print("🚀 Initializing RAG-Chaos agent retrieval sequence...")
...
`;
      ...
      compiledCode.primary_config = `-- Database indexing trigger setup for RAG-Chaos
...
`;
      ...
      compiledCode.primary_config = `# SRE Config template for RAG-Chaos
...
`;
    ...
    compiledCode.env_config = `# Environment settings for RAG-Chaos
MODEL_ENDPOINT="${endpoint}"
...
# SRE validation checks helper for RAG-Chaos
set -euo pipefail
...
echo "✅ Operational check complete for rag-chaos"
`;
...
`;
  ...
  window.SreCore.setupStudioTabs(
    ...
    (tabName) => {
      activeTab = tabName;
      let name = 'chaos_experiment.yaml';
