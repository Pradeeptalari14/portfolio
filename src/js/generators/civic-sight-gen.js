// Civic Sight SRE compiler logic
...
# Developer Studio configuration compiled for Civic Sight
...
def init_rag_node():
    print("🚀 Initializing Civic Sight agent retrieval sequence...")
...
`;
      ...
      compiledCode.primary_config = `-- Database indexing trigger setup for Civic Sight
...
`;
      ...
      compiledCode.primary_config = `# SRE Config template for Civic Sight
...
`;
    ...
    compiledCode.env_config = `# Environment settings for Civic Sight
MODEL_ENDPOINT="${endpoint}"
...
# SRE validation checks helper for Civic Sight
set -euo pipefail
...
echo "✅ Operational check complete for civic-sight"
`;
...
`;
  ...
  window.SreCore.setupStudioTabs(
    ...
    (tabName) => {
      activeTab = tabName;
      let name = 'whatsapp_grievance.json';
