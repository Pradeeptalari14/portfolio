...
const $ = (id) => document.getElementById(id);
  ...
  updateViewportContent();
    ...
    function compileVariables() {
      ...
      code += `AWS_ACCESS_KEY_ID="<YOUR_AWS_ACCESS_KEY_ID>"\n`;
      code += `AWS_SECRET_ACCESS_KEY="<YOUR_AWS_SECRET_ACCESS_KEY>"\n`;
      code += `AWS_S3_BUCKET_NAME="production-sre-static-assets"\n`;
      code += `K8S_SERVER_IP="https://10.0.0.1:6443"\n`;
      code += `K8S_TOKEN="<YOUR_KUBERNETES_SERVICE_ACCOUNT_TOKEN>"\n`;
      code += `SONAR_HOST_URL="https://sonarcloud.io"\n`;
      code += `SONAR_TOKEN="<YOUR_SONAR_TOKEN>"\n`;
...
function compileMermaidFlow() {
  let chart = 'graph TD\n  Commit[🦊 Git Commit] -->|Trigger| GitLab[🦊 GitLab CI/CD]\n  GitLab -->|Lint| Scan[🛡️ Security Analysis]\n  GitLab -->|Build| Package[🐳 Container Registries]\n  GitLab -->|Deploy| Host[🚀 Target Hosts]';
