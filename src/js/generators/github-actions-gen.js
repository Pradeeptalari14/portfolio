...
function compileMermaidFlow() {
  let chart = 'graph TD\n  Commit[🐱 Git Checkout] -->|Run Actions| Runner[⚙️ GitHub Runner]\n  Runner -->|Quality Scans| Sonar[🛡️ SonarCloud Audit]\n  Runner -->|Containerize| Docker[🐳 Docker Build & Push]\n  Docker -->|Deploy| Staging[🚀 Environment Host]';
