// KubeRAG Operator SRE compiler logic
...
# Developer Studio configuration compiled for KubeRAG Operator
...
def init_rag_node():
    print("🚀 Initializing KubeRAG Operator agent retrieval sequence...")
...
`;
      ...
      compiledCode.primary_config = `-- Database indexing trigger setup for KubeRAG Operator
...
`;
      ...
      compiledCode.primary_config = `# SRE Config template for KubeRAG Operator
...
`;
    ...
    compiledCode.env_config = `# Environment settings for KubeRAG Operator
MODEL_ENDPOINT="${endpoint}"
...
# SRE validation checks helper for KubeRAG Operator
set -euo pipefail
...
echo "✅ Operational check complete for kuberag-operator"
`;
...
`;
  ...
  window.SreCore.setupStudioTabs(
    ...
    (tabName) => {
      activeTab = tabName;
      let name = 'operator_deployment.yaml';
