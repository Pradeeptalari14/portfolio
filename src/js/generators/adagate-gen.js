...
# Developer Studio configuration compiled for AdaGate
...
def init_rag_node():
    print("🚀 Initializing AdaGate agent retrieval sequence...")
...
`;
      ...
      compiledCode.primary_config = `-- Database indexing trigger setup for AdaGate
...
`;
      ...
      compiledCode.primary_config = `# SRE Config template for AdaGate
...
`;
    ...
    compiledCode.env_config = `# Environment settings for AdaGate
MODEL_ENDPOINT="${endpoint}"
...
# SRE validation checks helper for AdaGate
set -euo pipefail
...
echo "✅ Operational check complete for adagate"
`;
...
`;
  ...
  window.SreCore.setupStudioTabs(
    ...
    (tabName) => {
      activeTab = tabName;
      let name = 'evidence_controller.py';
