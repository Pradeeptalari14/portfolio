...
# Developer Studio configuration compiled for ProtecRAG
...
def init_rag_node():
    print("🚀 Initializing ProtecRAG agent retrieval sequence...")
...
`;
      ...
      compiledCode.primary_config = `-- Database indexing trigger setup for ProtecRAG
...
`;
      ...
      compiledCode.primary_config = `# SRE Config template for ProtecRAG
...
`;
    ...
    compiledCode.env_config = `# Environment settings for ProtecRAG
MODEL_ENDPOINT="${endpoint}"
...
# SRE validation checks helper for ProtecRAG
set -euo pipefail
...
echo "✅ Operational check complete for protecrag"
`;
...
`;
  ...
  window.SreCore.setupStudioTabs(
    ...
    (tabName) => {
      activeTab = tabName;
      let name = 'guardrails_rules.yaml';
