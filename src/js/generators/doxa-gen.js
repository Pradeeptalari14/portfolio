...
# Developer Studio configuration compiled for doxa
...
def init_rag_node():
    print("🚀 Initializing doxa agent retrieval sequence...")
...
`;
      ...
      compiledCode.primary_config = `-- Database indexing trigger setup for doxa
...
`;
      ...
      compiledCode.primary_config = `# SRE Config template for doxa
...
`;
    ...
    compiledCode.env_config = `# Environment settings for doxa
MODEL_ENDPOINT="${endpoint}"
...
# SRE validation checks helper for doxa
set -euo pipefail
...
echo "✅ Operational check complete for doxa"
`;
...
`;
  ...
  window.SreCore.setupStudioTabs(
    ...
    (tabName) => {
      activeTab = tabName;
      let name = 'provenance_checker.py';
