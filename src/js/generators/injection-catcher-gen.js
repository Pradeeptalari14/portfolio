// Injection Catcher SRE compiler logic
...
# Developer Studio configuration compiled for Injection Catcher
...
def init_rag_node():
    print("🚀 Initializing Injection Catcher agent retrieval sequence...")
...
`;
      ...
      compiledCode.primary_config = `-- Database indexing trigger setup for Injection Catcher
...
`;
      ...
      compiledCode.primary_config = `# SRE Config template for Injection Catcher
...
`;
    ...
    compiledCode.env_config = `# Environment settings for Injection Catcher
MODEL_ENDPOINT="${endpoint}"
...
# SRE validation checks helper for Injection Catcher
set -euo pipefail
...
echo "✅ Operational check complete for injection-catcher"
`;
...
`;
  ...
  window.SreCore.setupStudioTabs(
    ...
    (tabName) => {
      activeTab = tabName;
      let name = 'injection_detector.py';
